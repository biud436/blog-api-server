...
export class AdminService {
  ...
  async addCategory(categoryName: string, rootNodeName?: string) {
    return await this.categoryService.addCategory(categoryName, rootNodeName);
  }
  ...
  async moveCategory(
    ...
    try {
      const res = await this.categoryService.moveCategory(moveCategoryDto);
  ...
  async getAncestors(categoryName: string) {
    try {
      ...
      const res = await this.categoryService.getAncestors(nodeList, targetNode);
